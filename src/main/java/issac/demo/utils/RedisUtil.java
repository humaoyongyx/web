...
public class RedisUtil {
    ...
    private RedisUtil() {
    	...
    	if (jedisPool == null) {
			...
			try {
				redisProperties.load(this.getClass().getClassLoader().getResourceAsStream("redis.properties"));
				logger.info(redisProperties.toString());
				String host = redisProperties.getProperty("host") == null ? Protocol.DEFAULT_HOST : redisProperties.getProperty("host");
				int port = redisProperties.getProperty("port") == null ? Protocol.DEFAULT_PORT : Integer.parseInt(redisProperties.getProperty("port"));
				...
				int maxIdle = redisProperties.getProperty("maxIdle") == null ? JedisPoolConfig.DEFAULT_MAX_IDLE : Integer.parseInt(redisProperties.getProperty("maxIdle"));
				...
				logger.info("redis.properties cannot find in classpath...");
				e.printStackTrace();
			}
