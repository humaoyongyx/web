...
public class FreemarkerUtils {
	...
	private static final String ROOT_DIR = "/ftl";

    static{
        try {
			initConfig(TEMPLATE_LOADING_PROJECT, ROOT_DIR);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void initConfig(Integer type,String dir) throws Exception{
        ...
        if(TEMPLATE_LOADING_PROJECT == type){
            freemarkerConfig.setClassForTemplateLoading(FreemarkerUtils.class,dir);
        }
    }
