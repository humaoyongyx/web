...
<script type="text/javascript" src="${path}/resources/js/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="${path}/resources/js/bootstrap-datepicker.zh-CN.min.js"></script>
